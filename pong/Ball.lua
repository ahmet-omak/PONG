...
function Ball:init(x, y, width, height)
    ...
    self.dx = math.random(2) == 1 and math.random(-100, 300) 
end
...
--renders ball
function Ball:render()   love.graphics.rectangle('fill', self.x, self.y, self.width, self.height) end